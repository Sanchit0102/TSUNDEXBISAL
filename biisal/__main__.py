...
async def start_services():
    ...
    print('---------------------------------------------------------------------------------------------------------')
    print('---------------------------------------------------------------------------------------------------------')
    print(' follow me for more such exciting bots! https://github.com/sanchit0102')
    print('---------------------------------------------------------------------------------------------------------')
    print('\n')
    ...
    print(LOGO)
    try: 
        await StreamBot.send_message(chat_id=Var.OWNER_ID[0] ,text='<b>ᴊᴀɪ sʜʀᴇᴇ Rᴀᴍ 😎\nʙᴏᴛ ʀᴇsᴛᴀʀᴛᴇᴅ !!</b>')
